...
public interface IConfigQueryService {
    ...
    /** Full list — returns every config (used by RPC + caches). */
    List<ConfigVO> list();
    /** Paginated list for the admin UI. */
    PageResult<ConfigVO> page(int pageNum, int pageSize, String keyword, Boolean builtIn);

    record ConfigVO(String id, String configKey, String configValue,
                    String configName, Boolean builtIn, String remark, LocalDateTime createdAt) {}
}
